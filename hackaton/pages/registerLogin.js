...
export default function Home() {
    // Use state to keep track of users
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="relative mb-6" data-te-input-wrapper-init>
                                    ...
                                    <label
                                        ...
                                        className={`absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-gray-500 transition-all duration-200 ease-out ${formData.password ? "-translate-y-[1.15rem] scale-[0.8]" : ""} peer-focus:-translate-y-[1.15rem] peer-focus:scale-[0.8] peer-focus:text-primary motion-reduce:transition-none dark:text-gray-400 dark:peer-focus:text-primary`}
                                    >
                                        Password
                                    </label>
                                </div>
